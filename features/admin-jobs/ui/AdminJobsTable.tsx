      ...
      <table className="w-full text-left text-sm whitespace-nowrap">
        <thead className="bg-rsg-surface/50 text-foreground/60 font-medium border-b border-border">
          <tr>
            ...
            <th className="px-6 py-4 font-mono text-[10px] uppercase tracking-widest">{t.installDate}</th>
            ...
            >
              ...
              <td className="px-6 py-4" onClick={(e) => e.stopPropagation()}>
                ...
                >
                  ...
                  <option value="installer_juan" className="bg-background text-foreground">JUAN</option>
                  <option value="installer_carlos" className="bg-background text-foreground">CARLOS</option>
                </select>
              </td>
              <td className="px-6 py-4">

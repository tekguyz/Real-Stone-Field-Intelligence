    ...
    <div className="bg-card border border-border flex flex-col h-full min-h-0">
      {isLoading ? (
        ...
        <div className="relative flex-1 min-h-0 flex flex-col">
          ...
          <div className="block md:hidden overflow-y-auto flex-1 p-3 space-y-3 custom-scrollbar bg-background/30">
            {sortedData.map((job) => {
      ...
      <div className="overflow-auto flex-1 min-h-0 custom-scrollbar hidden md:block">

...
export function SuccessOverlay({ importCount }: SuccessOverlayProps) {
  return (
    ...
    >
      ...
      <h3 className="text-4xl font-black uppercase tracking-tighter italic text-rsg-background">SUCCESS: {importCount} JOBS IMPORTED</h3>
      <p className="font-mono text-xs uppercase tracking-widest mt-2 opacity-80 text-rsg-background">Hydration Complete • Dashboard Updated</p>
    </motion.div>
  );
}

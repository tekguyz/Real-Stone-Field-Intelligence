...
mockInventory.push(
  {
    id: "lot-8991",
    materialName: "Calacatta Gold Marble",
    slabs: 5,
    thickness: "2cm",
    status: "on-site",
    job_legacy_id: null,
  ...
  {
    id: "lot-8992",
    materialName: "Super White Quartzite",
    slabs: 3,
    thickness: "3cm",
    status: "in-transit",
    job_legacy_id: null,
...
export function useInventoryController() {
  ...
  const stats = useMemo(
    () => ({
      ...
      onSite: mockInventory
        .filter((l) => l.status === "on-site")
        .reduce((acc, lot) => acc + lot.slabs, 0),
      inTransit: mockInventory

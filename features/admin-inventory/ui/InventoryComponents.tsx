...
export function InventoryFilters({ search, setSearch }: { search: string, setSearch: (s: string) => void }) {
  return (
...
export function InventoryTable({ lots, language }: { lots: InventoryLot[], language: 'en' | 'es' }) {
...
export function InventoryMetrics({ stats, language }: { stats: any, language: 'en' | 'es' }) {
  const t = dict[language].admin;
